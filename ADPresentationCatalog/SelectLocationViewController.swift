...
protocol SelectionLocationViewControllerDelegate: NSObjectProtocol {
    func selectLocationViewControllerDidSelect(location: SelectLocationViewController.Location)
}

class SelectLocationViewController: UIViewController {
    var selectedLocationState: Location = .middleMiddle
    ...
    weak var delegate: SelectionLocationViewControllerDelegate?
    ...
    @objc func didTapButton(_ sender: UIButton) {
        ...
        delegate?.selectLocationViewControllerDidSelect(location: location)
    }
}
